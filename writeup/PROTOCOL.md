...
- one-way: rel_l2 0.2457, amplitude ratio 1.098, centroid shift 0.17 cells,
  final data loss 3.339 — converged, and still 1.79x worse in L2 with a
  visible model-mismatch floor (its best fit is 65% above the noise floor on
  data generated by the coupled physics).

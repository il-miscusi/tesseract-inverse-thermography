...
- One-way arm: relative L2 error **0.2457** — 1.79x the coupled error, with a
  converged data loss 65% above the noise floor (3.34 vs 2.02): the frozen
  viscosity model cannot explain data generated by the coupled physics.
